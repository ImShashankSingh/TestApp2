...
namespace TestApp.Managers
{
    ...
    {
        private async Task<IRestResult<string>> AddVendor(string firstName, string lastName, string email, string password, CancellationTokenSource cancellationTokenSource = default(CancellationTokenSource))
        {
